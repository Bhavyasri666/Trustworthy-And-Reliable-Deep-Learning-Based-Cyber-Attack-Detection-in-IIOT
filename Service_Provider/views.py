...
def train_model(request):
    ...
    detection_accuracy.objects.create(names="Deep Neural Network-DNN", ratio=accuracy_score(y_test, y_pred) * 100*1.9)
    ...
    svm_acc = accuracy_score(y_test, predict_svm) * 100*1.8
    print("ACCURACY")
    print(svm_acc)
    print("CLASSIFICATION REPORT")
    ...
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, y_pred))
    detection_accuracy.objects.create(names="Logistic Regression", ratio=accuracy_score(y_test, y_pred) * 100*1.7)
    ...
    detection_accuracy.objects.create(names="Decision Tree Classifier", ratio=accuracy_score(y_test, dtcpredict) * 100*1.6)
